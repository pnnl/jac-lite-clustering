...
/**
 * <p>An iterator over a list of float primitives (<tt>FloatList</tt>)</p>.
 *
 * @author R. Scarberry, Vern Crow
 * @version 1.0
 * @see FloatList
 * @see FloatCollectionIterator
 */
public interface FloatListIterator extends FloatCollectionIterator {

    /**
     * Position to the start of the iteration.  If the backing <tt>FloatList</tt>
    ...
    /**
     * Position to the end of the iteration.  If the backing <tt>FloatList</tt>
     ...
     * This call can be made only if neither <tt>FloatListIterator.remove</tt> nor
     * <tt>FloatListIterator.add</tt> have been called after the last call to
