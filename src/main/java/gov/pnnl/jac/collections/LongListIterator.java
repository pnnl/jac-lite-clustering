...
/**
 * <p>Defines iterators over the elements of instances of <tt>LongList</tt>.</p>
 *
 * @author R. Scarberry
 */
public interface LongListIterator extends LongCollectionIterator {

    /**
     * Position to the start of the iteration.  If the backing <tt>IntList</tt>
    ...
    /**
     * Position to the end of the iteration.  If the backing <tt>IntList</tt>
     ...
     * This call can be made only if neither <tt>IntListIterator.remove</tt> nor
     * <tt>IntListIterator.add</tt> have been called after the last call to
