...
/**
 * <p>Defines a dynamically growing list for containing integer
 * primitives (<tt>int</tt>s).</p>
 *
...
public interface IntList extends IntCollection {
     ...
     * the list.
     * @return int[] - array of values contained in the list.
     */
    int[] toArray();
     ...
     */
    int indexOf(int startIndex, int value);
