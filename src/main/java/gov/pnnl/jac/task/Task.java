...
public interface Task<V> extends Runnable, Future<V>, Cancelable {
    ...
    /**
     * Associates a ProgressMonitor dialog with this task.  If you click the cancel
     ...
     * of the task to post messages or progress check the cancellation status of
     * the monitor and also cancel the task.  
     * @param pm
     */
