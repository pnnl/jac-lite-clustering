...
/**
 * Interface to define objects that map float keys to object values.  This
 ...
 * @version 1.0
 */
public interface FloatObjectMap<E> {
   ...
   *            <tt>null</tt>.
   */
  void putAll(FloatObjectMap<? extends E> map);
  ...
  /**
   * A map entry (key-value pair).  The <tt>FloatObjectMap.entrySet</tt> method returns
