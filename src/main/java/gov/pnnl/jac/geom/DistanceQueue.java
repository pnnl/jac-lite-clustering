...
import gov.pnnl.jac.collections.IntHashSet;
import gov.pnnl.jac.collections.IntSet;
import java.util.*;
...
public final class DistanceQueue implements java.io.Serializable {
    ...
    private transient IntSet mIDSet;
    ...
    public DistanceQueue(int capacity, double maxDistance) {
        ...
        mIDSet = new IntHashSet(capacity);
    }
