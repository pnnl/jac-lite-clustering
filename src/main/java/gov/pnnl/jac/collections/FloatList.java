...
/**
 * <p>Defines a dynamically growing list for containing float
 * primitives (<tt>float</tt>s).</p>
 *
 ...
 * @version 1.0
 */
public interface FloatList extends FloatCollection, Cloneable {

    /**
     * Returns the elements contained in this list in the order they appear in
     * the list.
     * @return float[] - array of values contained in the list.
     */
    float[] toArray();
     ...
     */
    int indexOf(int startIndex, float value);
    ...
    /**
     * Implementations should provide a deep-copy clone method.
     * @return
     */
    FloatList clone();
}
