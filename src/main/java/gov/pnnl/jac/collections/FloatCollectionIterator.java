...
/**
 * An iterator over a collection of float primitives (<tt>FloatCollection</tt>).
 *
 ...
 */
public interface FloatCollectionIterator extends Cloneable {
     ...
     * underlying <tt>FloatCollection</tt> (optional operation).
