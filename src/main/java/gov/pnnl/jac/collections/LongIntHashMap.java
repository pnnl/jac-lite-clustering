...
* @version 1.0
*/
public class LongIntHashMap implements LongIntMap, Cloneable {
    ...
    */
    public boolean equals(Object o) {
        ...
        return (o instanceof LongIntHashMap ? MapUtils.checkEqual(this,
                (LongIntMap) o) : false);
    }
    ...
    */
    public Object clone() {
        try {
            LongIntHashMap clone = (LongIntHashMap) super.clone();
    ...
    private class Itr implements LongCollectionIterator {
        ...
        public void remove() {
            ...
            if (mStates[mLastReturnNdx] == FULL) {
                try {
                    LongIntHashMap.this.remove(mKeys[mLastReturnNdx]);
                    mLastReturnNdx = -1;
