...
/**
* Interface to define objects that map integer keys to integer values
*
...
public interface IntIntMap {
    ...
    */
    ...
    /**
     * Returns the sum of the values associated with the specified keys.  
     * Elements of keys not present in the map do not influence the sum.
     * 
     * @param keys
     * 
     * @return summation of values mapped to the specified keys.
     */
    int getSum(int[] keys);
    ...
    */
    ...
    /**
     * Maps the specified integer key to the specified value in this map, if
     * that key is not already present.  If the key is present, the value 
     * already mapped to the key is incremented by the parameter value.
     * 
     * (This is an optional operation to permit read-only implementations.)
     * The previous mapping for the key, if present, is overwritten.
     *
     ...
     *              prevents it from being stored in this map.
     */
    int putOrIncrement(int key, int value);
