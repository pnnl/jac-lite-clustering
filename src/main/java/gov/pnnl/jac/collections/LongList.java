...
/**
 * <p>Defines a dynamically growing list for containing long integer
 * primitives (<tt>long</tt>s).</p>
 *
...
public interface LongList extends LongCollection {
     ...
     * the list.
     * @return long[] - array of values contained in the list.
     */
    long[] toArray();
     ...
     */
    int indexOf(int startIndex, long value);
