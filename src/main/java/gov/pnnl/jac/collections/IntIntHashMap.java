...
/**
* <tt>IntIntHashMap</tt> is an implementation of <tt>IntIntMap</tt> that
* maps integer keys to integer values using hashing.
*
...
* @version 1.0
*/
public class IntIntHashMap implements IntIntMap, Cloneable {
    ...
    */
    ...
    public int putOrIncrement(int key, int value) {
        ...
        if (ndx < 0) { // Negative index means the key was already contained.
            ...
            // But increment the current value.
            value += mValues[ndx];
        }
    ...
    * <tt>true</tt> if the specified object is also an <tt>IntIntMap</tt> and the two
    ...
    */
    public boolean equals(Object o) {
        return (o instanceof IntIntMap ? MapUtils.checkEqual(this,
                (IntIntMap) o) : false);
    }
    ...
    */
    public Object clone() {
        try {
            IntIntHashMap clone = (IntIntHashMap) super.clone();
    ...
    private class Itr implements IntCollectionIterator {
        ...
        public void remove() {
            ...
            if (mStates[mLastReturnNdx] == FULL) {
                try {
                    IntIntHashMap.this.remove(mKeys[mLastReturnNdx]);
                    mLastReturnNdx = -1;
