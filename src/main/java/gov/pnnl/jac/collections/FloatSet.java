...
/**
 * <tt>FloatSet</tt> is an interface defining entities that store floats
 * (primitive <tt>float</tt>) values in a set.  No duplicate entries are
 * permitted.  Each unique float value is contained once or not at all.
 *
...
public interface FloatSet extends FloatCollection {
     ...
     *   receiver.
     */
    FloatSet unionWith(FloatSet other);
     ...
     *   receiver.
     */
    FloatSet intersectionWith(FloatSet other);
     ...
     *   receiver.
     */
    FloatSet xorWith(FloatSet other);
