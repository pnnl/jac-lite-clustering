...
/**
 * <p>Implementation of <tt>DoubleObjectMap</tt> that uses hashing to map
 ...
 * @version 1.0
 */
public class DoubleObjectHashMap<E> implements DoubleObjectMap<E>, Cloneable {
   ...
   *            <tt>null</tt>.
   */
  public void putAll(DoubleObjectMap<? extends E> map) {
   ...
   */
  public Set<DoubleObjectMap.Entry<E>> entrySet() {
    Set<DoubleObjectMap.Entry<E>> set = new HashSet<DoubleObjectMap.Entry<E>>(2*mFullCount);
    if (mFullCount > 0) {
      final byte[] states = mStates;
      final double[] keys = mKeys;
      final Object[] values = mValues;
  ...
  public boolean equals(Object o) {
    return (o instanceof DoubleObjectMap<?> ? MapUtils.checkEqual(this, (DoubleObjectMap<?>) o) : false);
  }
  ...
  public Object clone() {
    try {
      DoubleObjectHashMap<E> clone = (DoubleObjectHashMap<E>) super.clone();
   ...
   private class Itr implements DoubleCollectionIterator {
     ...
     public void remove() {
       ...
       if (mStates[mLastReturnNdx] == FULL) {
         try {
           E removed = DoubleObjectHashMap.this.remove(mKeys[mLastReturnNdx]);
           mLastReturnNdx = -1;
  ...
  private static class Entry<E> implements DoubleObjectMap.Entry<E> {

    double key;
    E value;

    Entry(double key, E value) {
        this.key = key;
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof DoubleObjectMap.Entry<?>) {
          DoubleObjectMap.Entry<?> e = (DoubleObjectMap.Entry<?>) o;
          return (key == e.getKey() &&
    ...
    @Override
    public int hashCode() {
      return 37*HashAndEqualityUtils.hash(key) + (value == null ? 0 : value.hashCode());
    }
